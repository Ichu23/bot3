...
from database.connections_mdb import active_connection, all_connections, delete_connection, if_active, make_active, \
    make_inactive
from info import ADMINS, AUTH_CHANNEL, AUTH_USERS, CUSTOM_FILE_CAPTION, AUTH_GROUPS, PUBLIC_FILE_STORE, DELETE_TIME, P_TTI_SHOW_OFF, IMDB, REDIRECT_TO, \
...
async def next_page(bot, query):
    ...
    btn.insert(1,
        [ 
            InlineKeyboardButton(f'ᴍᴏᴠɪᴇs', url='https://t.me/CinemaCollections'),
            InlineKeyboardButton(f'sᴇʀɪᴇs', url='https://t.me/+qREDEldQNgFhMDll'),
...
async def advantage_spoll_choker(bot, query):
    ...
    if not movies:
        return await query.answer("𝖱𝖾𝗊𝗎𝖾𝗌𝗍 𝖠𝗀𝖺𝗂𝗇, 𝖥𝗂𝗅𝖾 𝖫𝗂𝗇𝗄 𝖾𝗑𝗉𝗂𝗋𝖾𝖽.", show_alert=True)
    movie = movies[(int(movie_))]
    await query.answer('sᴇᴀʀᴄʜɪɴɢ...')
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if chat_type == "private":
            ...
            return await query.answer('sᴀᴡᴀᴅɪᴋᴀ ʜᴀᴘᴘʏ ɴᴏᴡ')
    ...
    if query.data.startswith("file"):
            ...
            msg1 = await query.message.reply(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton("⚠️ 𝖢𝖺𝗇'𝗍 𝖠𝖼𝖼𝖾𝗌𝗌 ❓ 𝖢𝗅𝗂𝖼𝗄 𝖧𝖾𝗋𝖾 ⚠️", url=f'PUBLIC_FILE_STORE')
                        ]
                    ]
                )
            )
     ...
     [
        ...
        buttons = [[
        InlineKeyboardButton('ᴅᴇᴠ', url='https://t.me/DhashamoolamDhamu'),
        InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.delete()
        ...
        await query.answer("sᴇɴᴅ ᴄᴏʀʀᴇᴄᴛ ᴍᴏᴠɪᴇ/sᴇʀɪᴇs ɴᴀᴍᴇ ғᴏʀ ʙᴇᴛᴛᴇʀ ʀᴇsᴜʟᴛs .\nᴛᴏ ɢᴇᴛ ʙᴇᴛᴛᴇʀ ʀᴇsᴜʟᴛ ғᴏʀ sᴇʀɪᴇs sᴇᴀʀᴄʜ ʟɪᴋᴇ ᴇxᴀᴍᴘʟᴇ ɢɪᴠᴇɴ, \nʜʀɪᴅᴀʏᴀᴍ 𝟸𝟶𝟸𝟸  \nᴋɢғ 𝟸𝟶𝟸𝟸  \nᴋɢғ 𝟸𝟶𝟸𝟸 ᴍᴀʟᴀʏᴀʟᴀᴍ  n\n © 𝘾𝙞𝙣𝙚𝙢𝙖𝘾𝙤𝙡𝙡𝙚𝙘𝙩𝙞𝙤𝙣𝙨 ", True)
